...
# ──────────────────────────────────────────────────────────────────────────
#
# Note: §1.8.15 originally homed this enum at `openxp.schemas.readout`, but in
...
# `from openxp.schemas.report import NoShipReasonCode` contract used by
...
class Report(BaseModel):
    ...
    decision_rule_source: Literal["openxp_default", "user_defined"]

"""
Data discovery protocol for OpenXP.
...
knows about common column names — everywhere else in OpenXP, columns are
...
# only by the discovery layer — no other OpenXP code should reference them.

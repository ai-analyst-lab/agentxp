"""Canonical OpenXP error codes and default message/hint templates.
...
Usage::
    ...
    from openxp.errors import codes, ValidationError
...
HINTS: dict[str, str] = {
    ...
    E_LIFECYCLE_SKIP: (
        ...
        "openxp.storage.lifecycle.VALID_TRANSITIONS."
    ),
    E_LIFECYCLE_BACKWARD_NO_REASON: (
    ...
    E_DATA_TOO_LARGE: "Pre-aggregate in SQL, or sample before loading into OpenXP.",
    E_DATA_AMBIGUOUS: (
        "Use openxp.data.discovery.prepare_experiment_data() with explicit hints."
    ),

...
# Stage-0 profiler entry point for OpenXP v0.1.
...
def profile_dataset(
    ...
    *,
    ...
    # openxp.profiler import ...`` while that work is in flight.
    from openxp.profiler.duckdb_summarize import run_duckdb_summarize  # type: ignore[import-not-found]
    from openxp.profiler.heuristics import apply_hg_d4_heuristics  # type: ignore[import-not-found]

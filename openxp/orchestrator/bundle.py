"""Agent context-bundle assembly for OpenXP v0.1.
...
from openxp.orchestrator.project_lock import project_read_lock
    ...
    def __init__(self, bundles_dir: Path, project_root: Path):
        ...
        Args:
            ...
            project_root: The user's experiment project root — the directory
                ...
                ``metrics/``, ``assignments/``, and ``.openxp/.project.lock``.
        """

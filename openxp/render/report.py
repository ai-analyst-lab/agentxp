...
Distills the canonical `openxp.schemas.report.Report` (the report.json sidecar
...
writes atomically with chmod 600 via `openxp.audit.storage._atomic_write_bytes`.
"""
...
# This is NOT the canonical openxp.schemas.report.Report (which models the
...
class Report(BaseModel):
    ...
    the canonical `openxp.schemas.report.Report` into this shape.
    """
    model_config = ConfigDict(extra="forbid")
    schema_version: Literal[1] = 1
    experiment_id: str

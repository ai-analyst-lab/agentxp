"""Synchronous SQL dispatch chokepoint for OpenXP v0.1 (§11, §22.5, §13).
...
/ ``query.failed`` audit events from :mod:`openxp.audit.events`.
...
from openxp.sql.artifact_writer import _new_query_ulid, write_query_artifact
from openxp.sql.safety import SafetyViolation, run_pipeline
...
def dispatch_sql(
    ...
    1. Run :func:`openxp.sql.safety.run_pipeline` on the candidate SQL.

"""Canonical schemas for the OpenXP v0.1 SQL subsystem.
...
Source spec: experimentation-platform/OPENXP_V01_PLAN.md
  ...
  - §10.6    `openxp resume <exp_id>` orphan-query re-execution
...
from openxp.schemas.data_plan import FactSourceBinding
...
# Literal here is the contract that prevents `openxp connect <other>` from
...
# loader resolves to `~/.openxp/credentials/{adapter}/{profile}.yaml` at
...
class ConnectionConfig(BaseModel):
    ...
    ``~/.openxp/credentials/{adapter}/{profile_name}.yaml`` at dispatch time
    ...
    profile_name: str = Field(
        ...
        description=(
            ...
            "~/.openxp/credentials/{adapter}/. Never the credential value."
        ),
    )

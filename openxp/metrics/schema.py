"""
Metric definition schema for OpenXP.
...
the correct statistical test function in openxp.stats.
"""
...
def to_test_function(md: MetricDefinition) -> Callable:
    ...
    - proportion -> openxp.stats.proportion_test
    - mean       -> openxp.stats.welch_test
    - ratio      -> openxp.stats.ratio_metric_test
    """

...
Usage:
    from openxp.metrics import MetricRegistry, load_metric

    registry = MetricRegistry()  # autoloads ./metrics or ~/.openxp/metrics
    md = registry.get("checkout_completion_rate")
    test_fn = to_test_function(md)
"""

from openxp.metrics.schema import (
    MetricDefinition,
    MetricValidationError,
    to_test_function,
    validate,
)
from openxp.metrics.registry import (
    MetricRegistry,
    load_all_metrics,
    load_metric,
)

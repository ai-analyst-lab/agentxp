...
DEFAULT_ROOT = "~/.agentxp/experiments"
...
class ExperimentStore:
    ...
    def log_path(self, experiment_id: str) -> Path:
        ...
        Used by sibling packages (e.g. agentxp.amendments) that need to
...
def store_from_env() -> ExperimentStore:
    """Construct an ExperimentStore using AGENTXP_STORE env var or default root."""
    root = os.environ.get("AGENTXP_STORE", DEFAULT_ROOT)

"""
Opt-in computation tracing for agentxp.stats functions.
...
Usage
-----
    from agentxp.stats._trace import set_trace, is_trace_enabled, trace_dict
...
def set_trace(enabled: bool) -> None:
    """Enable or disable computation tracing for all agentxp.stats functions."""

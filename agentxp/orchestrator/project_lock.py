"""Project-level YAML concurrency for AgentXP v0.1.
...
for AgentXP's expected concurrency profile of <10 simultaneous orchestrators).

Lock file at ``{project}/.agentxp/.project.lock``; gitignored, auto-created

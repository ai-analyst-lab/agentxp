...
# adds html; Wave 5 adds card; the heavy png/pdf extras land later. The html and
# card instances here are the defaults (editorial-light); the CLI builds a
# configured instance when --theme/--audience are passed.

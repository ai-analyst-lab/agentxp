...
Optional power-user path for the profiler. The default ``agentxp profile``
...
ydata-profiling is an optional dependency (``pip install 'agentxp[deep-profile]'``);
    ...
    *,
    ...
    try:
        ...
        raise ImportError(
            ...
            "    pip install 'agentxp[deep-profile]'\n"

"""agentxp unlock — break a stale .state.lock for an experiment (W5.7).
...
from agentxp.audit.events import StageCommittedPayload
...
def _emit_stale_reclaimed(
    ...
    from agentxp.schemas.state import Stage  # local import to avoid cycle at top

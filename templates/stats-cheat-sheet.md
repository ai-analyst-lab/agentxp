...
| < 0.05 | Positive | Degraded beyond NIM | **INVESTIGATE** (quantify trade-off) |
| > 0.05 | Any | Clean | **LEARN** (was it powered enough?) |
| > 0.05 | Any | Degraded | **ABORT** (no benefit + guardrail risk) |
| < 0.05 | Negative | Any | **ABORT** |
| SRM detected | N/A | N/A | **INVALID** (fix randomization) |

...
- The orchestrator validates your output against `agentxp.schemas.consistency_judge.ConsistencyJudgeReport` (pydantic, `extra="forbid"`). Unknown top-level keys fail closed. Stick to the four documented top-level keys.
